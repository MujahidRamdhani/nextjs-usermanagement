...
const Textarea = React.forwardRef<
  HTMLTextAreaElement,
  React.ComponentProps<"textarea"> & { name: string; placehodeler?: string }
>(({ className, name, placehodeler, ...props }, ref) => {
  const {
    formState: { errors },
  } = useFormContext();
  ...
  return (
    <div className="relative w-full">
      <textarea
        name={name}
        placeholder={placehodeler} // Menggunakan placehodeler sebagai placeholder
        className={cn(
